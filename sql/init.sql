...
use moviereviewer;
create table if not exists users(id int auto_increment primary key, fname varchar(100) not null, lname varchar(100) not null, street varchar(100) not null, city varchar(100) not null, state varchar(20) not null, zip_code varchar(10) not null, email varchar(100) not null unique, password varchar(100) not null, phone varchar(50) not null);
